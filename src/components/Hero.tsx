...
const Hero = () => {
  ...
  const fullText = "Backend & DevOps Engineer | Cloud | Automation | AI-Driven Systems";
  ...
  const techStack = ['Node.js', 'Docker', 'Kubernetes', 'AWS', '.NET', 'React'];
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-8 text-sm md:text-base">
              ...
              <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-full px-4 py-2">
                <span className="text-purple-400 font-medium">Backend Specialist</span>
              </div>
              <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-full px-4 py-2">
                <span className="text-green-400 font-medium">DevOps Expert</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8 max-w-2xl mx-auto">
            <Button 
              className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-black font-medium px-6 py-3 text-base hover-glow rounded-full transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
            >
              <Download size={18} />
              Download Resume
            </Button>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8 max-w-4xl mx-auto">
            <div className="glass-effect rounded-xl p-6 text-left hover-glow group transition-all duration-300">
              <h3 className="text-lg font-bold text-cyan-400 mb-2 group-hover:text-cyan-300">Current Role</h3>
              <p className="text-white font-semibold mb-1">Jr Backend Developer</p>
              <p className="text-gray-400 text-sm mb-3">WebOsmotic • Sep 2023 - Jun 2025</p>
              <p className="text-gray-300 text-sm leading-relaxed">Built scalable real-time systems with AWS SQS + Socket.io, AI-powered document chat with Bedrock</p>
            </div>

            <div className="glass-effect rounded-xl p-6 text-left hover-glow group transition-all duration-300">
              <h3 className="text-lg font-bold text-purple-400 mb-2 group-hover:text-purple-300">Recent Project</h3>
              <p className="text-white font-semibold mb-1">Restaurant Platform</p>
              <p className="text-gray-400 text-sm mb-3">Freelance • Sep - Nov 2024</p>
              <p className="text-gray-300 text-sm leading-relaxed">Node.js APIs, Stripe integration, 30% operational efficiency boost through automation</p>
            </div>
          </div>
        </div>
